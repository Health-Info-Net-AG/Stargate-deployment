...
load_customer_config() {
  ...
  SG_ADMIN_PASSWORD="$(resolve_secret "$SG_ADMIN_PASSWORD" SG_ADMIN_PASSWORD)"
  ...
  persist_secret SG_ADMIN_PASSWORD "$SG_ADMIN_PASSWORD" "$CONFIG_FILE"
...
generate_keycloak_realm() {
  ...
  sed \
    ...
    -e "s|\${SG_ADMIN_PASSWORD}|${SG_ADMIN_PASSWORD}|g" \
...
echo "  Login:             sg-admin"
echo "  Password:          see SG_ADMIN_PASSWORD in $CONFIG_FILE"
echo ""
echo "  Keycloak Admin Console:"
echo "  -----------------------"
echo "  URL:               $KEYCLOAK_PUBLIC_URL/admin"
echo "  Username:          $KEYCLOAK_ADMIN_USER"
echo "  Password:          see KEYCLOAK_ADMIN_PASSWORD in $CONFIG_FILE"
