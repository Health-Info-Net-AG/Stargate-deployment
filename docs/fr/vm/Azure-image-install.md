# Déploiement HIN Gateway sur Azure à l'aide d'une image

Déployez HIN Gateway sur Azure
...
- Cliquez sur **+ Créer une règle de port**, Règle de port entrant, Plages de ports de destination 25, Protocole TCP, nommez-la SMTP. Répétez pour l'autre port entrant requis — **19818** (WireGuard). Voir [Exigences du serveur → Accès réseau entrant](../index.md#acces-reseau-entrant-le-pare-feu-doit-autoriser) pour la liste complète.
