# Déploiement HIN Gateway sur Cloudscale à l'aide d'une image
...
- Collez l'URL de l'image HIN Gateway dans le champ **URL de téléchargement**.
...
- Sous **Gestion du réseau**, activez uniquement **IPv4** si l'instance HIN Gateway doit être accessible sur Internet (par exemple, pour Office 365).
