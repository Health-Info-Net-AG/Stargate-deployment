...
5. **Fai quanto segue**: Selezionare **"Reindirizza il messaggio a..."** → **"il seguente connettore"** → selezionare il connettore in uscita creato al Passo A (es. "From Office 365 to HIN Gateway relay server")
   - Fare clic su **"Salva"**
