# Configurazione del relay di posta HIN Gateway

## Creare un relay HIN Gateway per un dominio di posta ospitato in Microsoft Office 365
...
Esempio rapido per il dominio `vrgnservices.eu` con IP HIN Gateway `128.140.117.200`:
...
## Installare i container docker compose di HIN Gateway

[Deployment HIN Gateway](./Docker-deploy.md)
...
Dobbiamo configurare connettori e una regola di trasporto in Exchange per inoltrare tutta la posta in uscita al relay HIN Gateway e consentire la posta in entrata da esso.
...
Dagli un nome come "From Office 365 to HIN Gateway relay server" e seleziona "Mantieni intestazioni email interne di Exchange", fai clic su "Avanti".
...
Inserisci l'indirizzo IP del server relay HIN Gateway, fai clic su "+", fai clic su "Avanti".
...
Dagli un nome come "Receive mail from HIN Gateway relay server" e seleziona "Mantieni intestazioni email interne di Exchange", fai clic su "Avanti".

![screenshot](./assets/new_connector_incoming2.png)

Seleziona "Verificando che l'indirizzo IP del server di invio corrisponda a uno dei seguenti indirizzi IP", digita l'indirizzo IP del server HIN Gateway, fai clic su "+", fai clic su "Avanti".
...
Dagli un nome come "Relay all mail to HIN Gateway except mail coming from it", scegli "Applica questa regola se" "Il destinatario:" "è esterno/interno" "Fuori dall'organizzazione", fai clic su "Salva".  

![screenshot](./assets/new_transport_rule2.png)

Scegli "Fai quanto segue" "Reindirizza il messaggio al seguente connettore" "From Office 365 to HIN Gateway relay server", fai clic su "Salva".

![screenshot](./assets/new_transport_rule3.png)

Scegli "Eccetto se L'indirizzo IP del mittente si trova in uno di questi intervalli" inserisci l'indirizzo IP del server HIN Gateway, fai clic su "Aggiungi", controlla l'indirizzo IP e fai clic su "Salva".
