...
- Fai clic su **+ Crea regola di porta**, Regola di porta in entrata, Intervalli di porte di destinazione 25, Protocollo TCP, chiamala SMTP. Ripeti per le altre porte in entrata richieste — **8084** (callback di sigillatura) e **19818** (WireGuard). Vedi [Requisiti del server → Accesso di rete in entrata](../index.md#accesso-di-rete-in-entrata-il-firewall-deve-consentire) per l'elenco completo.
